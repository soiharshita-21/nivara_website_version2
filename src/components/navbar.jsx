    ...
    <nav className="navbar">
      ...
      <ul className="navbar-menu">
        ...
        <li className="dropdown">
          <span>Products ▾</span>
          <ul className="dropdown-menu">
            <li><Link to="/products/home-loan">Home Loan for Purchase</Link></li>
            <li><Link to="/products/construction-loan">Construction Loan</Link></li>
            <li><Link to="/products/composite-loan">Composite Home Loan</Link></li>
            <li><Link to="/products/lap">Loan Against Property</Link></li>
            <li><Link to="/products/balance-transfer">Balance Transfer</Link></li>
          </ul>
        </li>
        ...
        <li className="dropdown">
          ...
          <ul className="dropdown-menu">
            <li><Link to="/customercenter/e-nach">E-Nach</Link></li>
        ...
        <li className="dropdown">
          <span>Media ▾</span>
          <ul className="dropdown-menu">
            <li><Link to="/media/blog">Blog</Link></li>
            <li><Link to="/media/press-release">Press Release</Link></li>
            <li><Link to="/media/nivara-gallery">Nivara Gallery</Link></li>
          </ul>
        </li>
        ...
        <li className="dropdown">
          ...
          <ul className="dropdown-menu">
            <li><Link to="/contactus/branch">Branch</Link></li>
            <li><Link to="/contactus/offices">Offices</Link></li>
          </ul>
        </li>
