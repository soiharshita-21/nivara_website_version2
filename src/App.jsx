  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/products/construction-loan" element={<ConstructionLoan />} />
        <Route path="/products/composite-loan" element={<CompositeHomeLoan />} />
        <Route path="/products/lap" element={<LoanAgainstProperty />} />
        <Route path="/products/balance-transfer" element={<BalanceTransfer />} />
       <Route path="/customercenter/e-nach" element={<ENach />} />
        <Route path="/customercenter/interest-rate" element={<InterestRate />} />
        <Route path="/customercenter/quick-link" element={<QuickLink />} />
        <Route path="/customercenter/fair-practice" element={<FairPractice />} />
        <Route path="/customercenter/publicdisclosure" element={<PublicDisclosure />} />
        <Route path="/customercenter/corporategovernance" element={<CorporateGovernance />} />
